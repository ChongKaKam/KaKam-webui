...
client fetch. Copy/export operate on the user-edited text. A failed regeneration
keeps the previous text. Server/provider cancellation follows existing HTTP behavior.
